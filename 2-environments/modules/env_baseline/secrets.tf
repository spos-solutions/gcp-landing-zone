...
module "env_secrets" {
  ...
  activate_apis               = var.enable_billing ? ["logging.googleapis.com", "secretmanager.googleapis.com"] : ["logging.googleapis.com"]
  ...
  budget_amount               = var.enable_billing ? var.project_budget.secret_budget_amount : null
